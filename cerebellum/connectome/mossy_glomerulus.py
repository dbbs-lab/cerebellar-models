...
class ConnectomeMossyGlomerulus(ConnectionStrategy):
    ...
    def get_region_of_interest(self, chunk):
        ...
        #We look for chunks inside the granular layer
        ...
        for c in chunks:
            ...
            if ((x_dist < self.x_length/2) and (z_dist < self.z_length/2)) and c[1]*c.dimensions[1] < self.scaffold.partitions.granular_layer.thickness:
