...
:class:`AdjacencyMatrix <.analysis.structure_analysis.AdjacencyMatrix>`
-----------------------------------------------------------------------
This class extracts and plots the adjacency matrix of the scaffold connectome
grouped by cell type populations. By default, the matrix is displayed in
the logarithm scale.
...
- A plot of the adjacency matrix, showing counts of synapses per pair of cell types
  (see section :ref:`adjacency_matrix`)
