.. Cerebellar-models documentation master file, created by
   sphinx-quickstart on Thu Jul  7 09:49:05 2022.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

DBBS Cerebellar models
======================

This repository provides the code, configuration and morphology data to reconstruct and simulate
cerebellar circuits using the `Brain Scaffold Builder <https://bsb.readthedocs.io/en/latest/>`_.
