...
problem.xl = np.array([0, 0.0, 0, 50, 0, 0, 0])
problem.xu = np.array([5, 1.0, 40.0, 350.0, 5, 15, 5])
...
plot_pareto_front(
    ...
    sol_idx,
    threshold=1,
    title="Pareto Front for GABA GoC_Grc",
    save_path="./figs/Pareto_GABA_GoC_GrC.png",
)
...
plot_conductance(
    ...
    title="GABA conductance GoC_GrC",
    xlim=(190, 600),
    duration=1201,
