...
# REMINDER: put nest.set_communicator(self.comm) in bsb-nest/adapter.py/set_settings()
...
class WeightsOptimizer(object):
    ...
    def set_weights(self, ind, simulation_name="basal_activity"):
