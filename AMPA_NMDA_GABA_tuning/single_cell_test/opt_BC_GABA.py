...
trace_file = "../NEURON_traces/Danilo_synapses/BCGABA.txt"
...
problem.xu = np.array([5, 5., 10., 100., 10, 10, 10])
...
output_filename = "./Optimized_params/params_GABA_BC.txt"
save_params(opt_params_dict, output_filename)
plot_pareto_front(res, sol_idx, threshold=1, title='Pareto Front for GABA BC', save_path='./figs/Pareto_GABA_BC.png')
...
plot_conductance(params=cell_params, sim_params=sim_params, trace_file=trace_file, E_rev=cell_params['GABA_E_rev'],
                 optimized_params=opt_params_dict, title="GABA conductance BC", xlim = (190,600), duration=1201,
