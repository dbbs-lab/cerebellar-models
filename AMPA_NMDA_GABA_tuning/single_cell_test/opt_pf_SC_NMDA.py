...
trace_file = "../NEURON_traces/Danilo_synapses/SCpfNMDA.txt"
...
output_filename = "./Optimized_params/params_NMDA_pf_SC.txt"
save_params(opt_params_dict, output_filename)
plot_pareto_front(res, sol_idx, threshold=1, title='Pareto Front for NMDA pf_SC', save_path='./figs/Pareto_NMDA_pf_SC.png')
...
plot_conductance(params=cell_params, sim_params=sim_params, trace_file=trace_file, E_rev=cell_params['NMDA_E_rev'],
                 optimized_params=opt_params_dict, title="NMDA conductance pf_SC", xlim = (190,700), mg_block=0.177, duration=1201,
                 save_path="./figs/opt_NMDA_pf_SC.png")