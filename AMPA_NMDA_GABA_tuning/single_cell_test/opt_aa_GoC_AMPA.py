...
trace_file = "../NEURON_traces/Danilo_synapses/GoCaaAMPA.txt"
...
problem.xu = np.array([5, 1., 5., 5., 5, 15, 5])
...
output_filename = "./Optimized_params/params_AMPA_aa_GoC.txt"
save_params(opt_params_dict, output_filename)
plot_pareto_front(res, sol_idx, threshold=1, title='Pareto Front for AMPA aa_GoC', save_path='./figs/Pareto_AMPA_aa_GoC.png')
...
plot_conductance(params=cell_params, sim_params=sim_params, trace_file=trace_file, E_rev=cell_params['AMPA_E_rev'],
                 optimized_params=opt_params_dict, title="AMPA conductance aa_Goc", xlim = (190,215),
                 save_path="./figs/opt_AMPA_aa_GoC.png", duration=1201)