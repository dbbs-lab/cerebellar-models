...
k=1.
syn_spec1 = {"weight": k*3. , "delay": 1, "receptor_type": 1}
syn_spec2 = {"weight": k*3. , "delay": 1, "receptor_type": 2}
syn_spec3 = {"weight": k*1. , "delay": 1, "receptor_type": 3}
...
multimeter = nest.Create("multimeter", params={"interval": 0.025,
                                               "record_from": ["V_m","V_m_2","I_dep","I_adap","I_syn","I_syn_ampa","I_syn_nmda",
                                                               "I_syn_gaba","Mg_block"], "record_to": "memory", "label": "grc_multimeter"})
