...
multimeter = nest.Create("multimeter", params={"interval": 0.025,
                                               "record_from": ["V_m","I_syn_ampa","I_syn_nmda", "I_ampa1", "I_ampa2", "I_nmda1", "I_nmda2", 'I_syn_gaba',
                                                               'I_gaba1', 'I_gaba2', 'Mg_block']
                                                               , "record_to": "memory", "label": "grc_multimeter"})
...
ax[0].plot(times_grc, g_syn_ampa1, label = "G_syn_ampa1 (fast)", color = 'gray', alpha = 0.5, linestyle = '--')
ax[0].plot(times_grc, g_syn_ampa2, label = "G_syn_ampa2 (slow)", color='blue', alpha = 0.5, linestyle = '--')
...
ax[1].plot(times_grc, g_syn_nmda1, label = "G_syn_nmda1 (fast)", color = 'gray', alpha = 0.5, linestyle = '--')
ax[1].plot(times_grc, g_syn_nmda2, label = "G_syn_nmda2 (slow)", color='blue', alpha = 0.5, linestyle = '--')
...
ax[2].plot(times_grc, g_syn_nmda1*Mg_block, label = "G_syn_nmda1 (fast)", color = 'gray', alpha = 0.5, linestyle = '--')
ax[2].plot(times_grc, g_syn_nmda2*Mg_block, label = "G_syn_nmda2 (slow)", color='blue', alpha = 0.5, linestyle = '--')
...
ax[3].plot(times_grc, g_syn_gaba1, label = "G_syn_gaba1 (fast)", color = 'gray', alpha = 0.5, linestyle = '--')
ax[3].plot(times_grc, g_syn_gaba2, label = "G_syn_gaba2 (slow)", color='blue', alpha = 0.5, linestyle = '--')
