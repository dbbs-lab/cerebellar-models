...
problem.xu = np.array([5, 1.0, 1.0, 5.0, 10, 20, 15])
...
plot_pareto_front(
    ...
    sol_idx,
    threshold=1,
    title="Pareto Front for AMPA pf_SC",
    save_path="./figs/Pareto_AMPA_pf_SC.png",
)
...
plot_conductance(
    ...
    title="AMPA conductance pf_SC",
    xlim=(190, 215),
    save_path="./figs/opt_AMPA_pf_SC.png",
    duration=1201,
)
