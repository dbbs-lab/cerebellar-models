...
problem.xu = np.array([5, 2.0, 2.0, 10.0, 5, 10, 5])
...
plot_pareto_front(
    ...
    sol_idx,
    threshold=1,
    title="Pareto Front for AMPA pf_GoC",
    save_path="./figs/Pareto_AMPA_pf_GoC.png",
)
...
plot_conductance(
    ...
    title="AMPA conductance pf_Goc",
    xlim=(195, 215),
    save_path="./figs/opt_AMPA_pf_GoC.png",
    duration=1201,
)
