...
problem.xu = np.array([5, 5., 10., 100., 5, 10, 5])
...
plot_pareto_front(res, sol_idx, threshold=1, title='Pareto Front for GABA SC', save_path='./figs/Pareto_GABA_SC.png')
...
plot_conductance(params=cell_params, sim_params=sim_params, trace_file=trace_file, E_rev=cell_params['GABA_E_rev'],
                 optimized_params=opt_params_dict, title="GABA conductance SC", xlim = (190,600), duration=1201,
