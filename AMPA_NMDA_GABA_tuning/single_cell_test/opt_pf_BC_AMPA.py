...
trace_file = "../NEURON_traces/Danilo_synapses/BCpfAMPA.txt"
...
problem.xu = np.array([5, 1., 1., 5., 10, 15, 10])
...
output_filename = "./Optimized_params/params_AMPA_pf_BC.txt"
save_params(opt_params_dict, output_filename)
plot_pareto_front(res, sol_idx, threshold=1, title='Pareto Front for AMPA pf_BC', save_path='./figs/Pareto_AMPA_pf_BC.png')
...
plot_conductance(params=cell_params, sim_params=sim_params, trace_file=trace_file, E_rev=cell_params['AMPA_E_rev'],
                 optimized_params=opt_params_dict, title="AMPA conductance pf_BC", xlim = (190,215),
                 save_path="./figs/opt_AMPA_pf_BC.png", duration=1201)