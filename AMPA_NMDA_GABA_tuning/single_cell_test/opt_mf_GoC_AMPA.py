...
problem.xu = np.array([5, 1.0, 5.0, 10.0, 5, 10, 5])
...
plot_pareto_front(
    ...
    sol_idx,
    threshold=1,
    title="Pareto Front for AMPA mf_GoC",
    save_path="./figs/Pareto_AMPA_mf_GoC.png",
)
...
plot_conductance(
    ...
    title="AMPA conductance mf_Goc",
    xlim=(195, 250),
    save_path="./figs/opt_AMPA_mf_GoC.png",
    duration=1201,
)
