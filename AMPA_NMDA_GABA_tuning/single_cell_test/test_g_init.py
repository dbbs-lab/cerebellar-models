...
def plot_conductance_A(times_sim, g_sim, ar, Ar,):
...
plt.legend(title='g_init value', bbox_to_anchor=(1.05, 1), loc='upper left', borderaxespad=0.)
plt.xlim(240, 275)
plt.ylim(0, 1.6)
plt.tight_layout()
...
plt.plot(g_init, fit, '--', label=f'Linear regression: y = {m:.2f}x + {q:.2f}', alpha=0.5, color='orange')
