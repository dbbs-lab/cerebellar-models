...
trace_file = "../NEURON_traces/Danilo_synapses/PCaxGABA.txt"
opt_param_names = [
    "GABA_g_init",
    "GABA_Tau_r",
    "GABA_Tau_d1",
...
output_filename = "./Optimized_params/params_GABA_SC_BC_PC.txt"
save_params(opt_params_dict, output_filename)
plot_pareto_front(
    res,
    sol_idx,
    threshold=1,
    title="Pareto Front for GABA  SC_BC_PC",
    save_path="./figs/Pareto_GABA_SC_BC_PC.png",
)
...
plot_conductance(
    ...
    title="GABA conductance SC_BC_PC",
    xlim=(190, 600),
    duration=1201,
    save_path="./figs/opt_GABA_SC_BC_PC.png",
)
