...
problem = SynapseOptimization(
    ...
    trace_file,
    opt_param_names,
    E_rev=cell_params["NMDA_E_rev"],
    mg_block=0.177,
    tmin=200,
    tmax=1200,
    duration=1201,
)  # For -40 mV patch clamp
problem.xl = np.array([0.0, 0.0, 15, 100, 0, 0, 0])
...
plot_pareto_front(
    ...
    sol_idx,
    threshold=1,
    title="Pareto Front for NMDA mf_GoC",
    save_path="./figs/Pareto_NMDA_mf_GoC.png",
)
