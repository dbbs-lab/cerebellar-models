...
trace_file = "../NEURON_traces/Danilo_synapses/GoCmfNMDA.txt"
...
problem.xl = np.array([0., 0.,  15, 100, 0, 0, 0])
problem.xu = np.array([5, 40.0, 100, 1000, 5, 5, 5])
...
output_filename = "./Optimized_params/params_NMDA_mf_GoC.txt"
save_params(opt_params_dict, output_filename)
plot_pareto_front(res, sol_idx, threshold=1, title='Pareto Front for NMDA mf_GoC', save_path='./figs/Pareto_NMDA_mf_GoC.png')
...
plot_conductance(params=cell_params, sim_params=sim_params, trace_file=trace_file, E_rev=cell_params['NMDA_E_rev'],
                 optimized_params=opt_params_dict, title="NMDA conductance mf_GoC", xlim = (190,700), mg_block=0.177, duration=1201,
                 save_path="./figs/opt_NMDA_mf_GoC.png")