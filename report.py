...
reco_file = "mouse_cereb_dcn_io_microzones_nest.hdf5"
nio_folder = "nio_files/micro_stim"
reco_pdf = "report_dcn_io_microzones.pdf"
...
LIST_CT_INFO = [
    ...
    PlotTypeInfo("purkinje_cell_minus", [0.275, 0.650, 0.275, 1.0], "PC-"),
    ...
    PlotTypeInfo("dcn_p_minus", [0.2, 0.2, 0.2, 1.0], "DCN_P-"),
    PlotTypeInfo("dcn_i_plus", [0.635, 0, 0.145, 1.0], "DCN_I+"),
    PlotTypeInfo("dcn_i_minus", [0.535, 0, 0.145, 1.0], "DCN_I-"),
    PlotTypeInfo("io_plus", [0.46, 0.376, 0.54, 1.0], "IO+"),
    PlotTypeInfo("io_minus", [0.46, 0.276, 0.54, 1.0], "IO-"),
]
